...
| `webapp.image.tag`                          | The airbyte webapp image tag. Defaults to the chart's AppVersion | `0.39.36-alpha`  |
...
| `server.image.tag`                          | The airbyte server image tag. Defaults to the chart's AppVersion | `0.39.36-alpha`  |
...
| `worker.image.tag`                          | The airbyte worker image tag. Defaults to the chart's AppVersion | `0.39.36-alpha`  |
...
| `bootloader.image.tag`          | The airbyte bootloader image tag. Defaults to the chart's AppVersion | `0.39.36-alpha`      |
